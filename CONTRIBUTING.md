# Contributing to Signers
:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

Welcome to the Signers repository!  The following is a set of guidelines for contributing to this 
...
start by explaining how you started Signers, e.g. which command exactly you used in the terminal, 
...
* **What version of Java are you running?** You can get the exact version by looking at the Signers 
...
1. [**Fork the repository**](https://github.com/PegaSysEng/signers/fork).
...
you can **"squash and merge"** your PR and you're done. You contributed to Signers! Thanks !
