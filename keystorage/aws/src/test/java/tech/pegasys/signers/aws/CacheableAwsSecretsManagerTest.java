...
class CacheableAwsSecretsManagerTest {
  ...
  private void setupSecretsManagers() {
    awsSecretsManagerDefault = CacheableAwsSecretsManager.createAwsSecretsManager(AWS_REGION);
    awsSecretsManagerExplicit =
        CacheableAwsSecretsManager.createAwsSecretsManager(
            RO_AWS_ACCESS_KEY_ID, RO_AWS_SECRET_ACCESS_KEY, AWS_REGION);

    awsSecretsManagerInvalidCredentials =
        CacheableAwsSecretsManager.createAwsSecretsManager("invalid", "invalid", AWS_REGION);
  }
  ...
  private void closeClients() {
    ...
    CacheableAwsSecretsManager.close();
  }
