...
public class MySelfSignedCertificate {
  ...
  public MySelfSignedCertificate(final KeyPair keyPair, final X509Certificate certificate) {
  ...
  public static MySelfSignedCertificate generate() {
    try {
      final KeyPair keyPair = generateKeyPair();
      return new MySelfSignedCertificate(
          keyPair,
  ...
  public void writePrivKeyToFile(final Path outputFile) throws IOException {
